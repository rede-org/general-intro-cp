...
Since this behavior will be created when the app starts, it can also serve as a new entry point to the application. To embrace that responsibility, it can be refactor to include the initial operation:
