...
- [A] Execute qualified operation(s).
    ...
    -> On continuation (continue).
        -> Jump to [A] for any remaining qualifying operations, then return here.
        -> Jump to [D], then return here.
        -> Jump to [E], then return here.
        -> Jump to [F], then return here.
...
Delayed activation/deactivation merely schedules activation/deactivation to occur after all currently qualifying and otherwise scheduled operations have completed. An activation that has been scheduled will be de-scheduled if it is deactivated prior to those scheduled activations being performed.
