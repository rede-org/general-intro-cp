...
<figure><picture><source srcset="../.gitbook/assets/Execution-Flow-Dark.svg" media="(prefers-color-scheme: dark)"><img src="../.gitbook/assets/Execution-Flow-Light.svg" alt="A diagram of boxes showing the flow from one stage and stream to another."></picture><figcaption></figcaption></figure>
